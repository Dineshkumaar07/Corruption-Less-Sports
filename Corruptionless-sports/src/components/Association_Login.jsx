...
export class Association_Login extends Component {
  render() {
    return (
        <>
        <div className="text-white  h-screen bg-no-repeat bg-cover p-36 flex items-center justify-center" style={{ backgroundImage: `url(${bg})`}}>
            <div className='h-40v w-40v bg-white/20 rounded-md'>
                <form className="flex flex-col gap-3 p-5"action="">
                    <h1 className='text-center text-3xl font-semibold'>Association Login</h1>
                    <div className='px-20'>
                        <input  className="mt-3 placeholder:italic placeholder:text-slate-400 block bg-white w-full border border-slate-300 rounded-md py-2 pl-9 pr-3 shadow-sm focus:outline-none focus:border-sky-500 focus:ring-sky-500 focus:ring-1 sm:text-sm text-black italic font-bold" type="text" placeholder="Enter Association ID"/>
...
export default Association_Login